    ...
    <>
      <div className="hidden lg:flex gap-14 container px-20 mx-auto">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-xl test-gray-700 semibold">Delivery</h3>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-xl test-gray-700">Dining Out</h3>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-xl test-gray-700">Nightlife</h3>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-xl test-gray-700">Nutrition</h3>
        </div>
      </div>
    </>
  );
